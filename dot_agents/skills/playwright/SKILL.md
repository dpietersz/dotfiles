...
- User just needs to fetch static content → Use web fetch directly
...
This system has Playwright available via an MCP server running in a distrobox container.

### Available Interfaces

| Interface | Purpose | When to Use |
|-----------|---------|-------------|
| **MCP Server** | Primary integration | Default for all browser automation |
