...
Using the user journeys from Sub-agent 1 and findings from Sub-agent 3, create a task (using the Task tool) for each user journey. Each task should include:
...
1. Query the database to verify records using the connection info from Sub-agent 2:
