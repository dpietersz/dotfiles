---
description: Codebase understanding workflow - multi-repository analysis, documentation lookup, implementation examples with GitHub permalinks
globs: ""
alwaysApply: false
---
...
Specialized codebase understanding for multi-repository analysis, searching remote codebases, retrieving official documentation, and finding implementation examples.
...
- **NEVER search for 2024** - Use current year in search queries
...
Tool 2: WebSearch("topic recent updates [current year]")
