---
description: Orchestrate a production-grade code review. Launches parallel sub-agents for architecture/scope, security, and quality enforcement — then fixes critical issues, incorrect docstrings, TODOs, and incomplete implementations inline. No corners cut.
---
...
1. Launch three sub-agents in parallel: scope/architecture/intent, security deep-dive, quality enforcement
