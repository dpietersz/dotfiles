...
export const TaskItem = Type.Object({ 
	...
	traits: Type.Optional(Type.Array(Type.String(), { description: "Behavioral traits for agent composition (e.g. ['security', 'skeptical', 'thorough'])" })),
});
...
export const SubagentParams = Type.Object({
	...
	chainName: Type.Optional(Type.String({
		description: "Chain name. For EXECUTION: run a saved .chain.md file (e.g. {chainName: 'refine-linear-issue', task: '...'}). For MANAGEMENT: target for get/update/delete actions."
	})),
	...
	traits: Type.Optional(Type.Array(Type.String(), { description: "Behavioral traits for agent composition (e.g. ['security', 'skeptical', 'thorough']). Dimensions: expertise (codebase-research, implementation, security, planning, code-review), personality (skeptical, disciplined, creative, analytical), approach (thorough, rapid, systematic)" })),
});
