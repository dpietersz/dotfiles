...
# [Introduction](https://zellij.dev/documentation/#introduction)
This is the documentation for the Zellij terminal workspace.
  * For installing Zellij, see: [Installation](https://zellij.dev/documentation/installation.html)
  * For configuring Zellij, see: [Configuration](https://zellij.dev/documentation/configuration.html)
  * For the CLI interface, see: [Controlling Zellij through the CLI](https://zellij.dev/documentation/controlling-zellij-through-cli.html)
  * For setting up layouts: [Layouts](https://zellij.dev/documentation/layouts.html)
  * For developing plugins: [Plugins](https://zellij.dev/documentation/plugins.html)


You can also check out some [Screencasts & Tutorials](https://zellij.dev/screencasts) about using Zellij.
[ ](https://zellij.dev/documentation/installation.html "Next chapter")
[ ](https://zellij.dev/documentation/installation.html "Next chapter")
