...
domain: "paseo.sh"
source: "https://paseo.sh/docs/security"
...
#  [#](https://paseo.sh/docs/security#security)Security
...
##  [#](https://paseo.sh/docs/security#architecture)Architecture
...
##  [#](https://paseo.sh/docs/security#relay-connections-recommended)Relay connections (recommended)
...
###  [#](https://paseo.sh/docs/security#how-it-works)How it works
  ...
  4. Both sides perform a Curve25519 ECDH key exchange to derive a shared key. All subsequent messages are encrypted with XSalsa20-Poly1305 (NaCl `box`).
...
###  [#](https://paseo.sh/docs/security#why-the-relay-cant-attack-you)Why the relay can't attack you
...
###  [#](https://paseo.sh/docs/security#trust-model)Trust model
...
##  [#](https://paseo.sh/docs/security#direct-connections)Direct connections
...
###  [#](https://paseo.sh/docs/security#socket-file-cli-only)Socket file (CLI only)
...
###  [#](https://paseo.sh/docs/security#vpn-access)VPN access
...
###  [#](https://paseo.sh/docs/security#binding-to-0000)Binding to 0.0.0.0
...
##  [#](https://paseo.sh/docs/security#dns-rebinding-protection)DNS rebinding protection
...
##  [#](https://paseo.sh/docs/security#password-authentication)Password authentication
...
The password is stored as a bcrypt hash in `config.json`, the daemon never stores it in plaintext. See [Configuration](https://paseo.sh/docs/configuration#password-authentication) for setup instructions.
###  [#](https://paseo.sh/docs/security#what-password-auth-does-and-does-not-do)What password auth does and does not do
...
###  [#](https://paseo.sh/docs/security#when-to-use-it)When to use it
...
##  [#](https://paseo.sh/docs/security#agent-authentication)Agent authentication
...
##  [#](https://paseo.sh/docs/security#recommendations)Recommendations
...
[View this page on GitHub](https://github.com/getpaseo/paseo/blob/main/public-docs/security.md)
