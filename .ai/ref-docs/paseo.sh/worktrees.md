...
domain: "paseo.sh"
source: "https://paseo.sh/docs/worktrees"
...
#  [#](https://paseo.sh/docs/worktrees#git-worktrees)Git worktrees
...
##  [#](https://paseo.sh/docs/worktrees#layout-and-workflow)Layout and workflow
...
##  [#](https://paseo.sh/docs/worktrees#paseojson)paseo.json
...
##  [#](https://paseo.sh/docs/worktrees#setup-and-teardown)Setup and teardown
...
##  [#](https://paseo.sh/docs/worktrees#scripts-and-services)Scripts and services
...
###  [#](https://paseo.sh/docs/worktrees#plain-scripts)Plain scripts
...
###  [#](https://paseo.sh/docs/worktrees#services)Services
...
###  [#](https://paseo.sh/docs/worktrees#reverse-proxy)Reverse proxy
...
###  [#](https://paseo.sh/docs/worktrees#service-to-service)Service-to-service
...
##  [#](https://paseo.sh/docs/worktrees#terminals)Terminals
...
##  [#](https://paseo.sh/docs/worktrees#environment-variables)Environment variables
...
##  [#](https://paseo.sh/docs/worktrees#cli)CLI
...
[View this page on GitHub](https://github.com/getpaseo/paseo/blob/main/public-docs/worktrees.md)
