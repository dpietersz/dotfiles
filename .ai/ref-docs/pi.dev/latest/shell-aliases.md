...
`Ctrl K`
  1. [](https://pi.dev/docs/latest/shell-aliases)
  2. [](https://pi.dev/docs/latest/shell-aliases)
  3. [](https://pi.dev/docs/latest/shell-aliases)
  4. [](https://pi.dev/docs/latest/shell-aliases)
  5. [](https://pi.dev/docs/latest/shell-aliases)
  6. [](https://pi.dev/docs/latest/shell-aliases)
  7. [](https://pi.dev/docs/latest/shell-aliases)
  8. [](https://pi.dev/docs/latest/shell-aliases)
  9. [](https://pi.dev/docs/latest/shell-aliases)
  10. [](https://pi.dev/docs/latest/shell-aliases)
...
[Development](https://pi.dev/docs/latest/development)
# Shell Aliases
Latest·[](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/shell-aliases.md)·[](https://github.com/earendil-works/pi/edit/main/packages/coding-agent/docs/shell-aliases.md)
