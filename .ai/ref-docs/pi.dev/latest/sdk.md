...
Navigation
On this page
[Quick Start](https://pi.dev/docs/latest/sdk#quick-start)[Installation](https://pi.dev/docs/latest/sdk#installation)[Core Concepts](https://pi.dev/docs/latest/sdk#core-concepts)[createAgentSession()](https://pi.dev/docs/latest/sdk#createagentsession)[AgentSession](https://pi.dev/docs/latest/sdk#agentsession)[createAgentSessionRuntime() and AgentSessionRuntime](https://pi.dev/docs/latest/sdk#createagentsessionruntime-and-agentsessionruntime)[Prompting and Message Queueing](https://pi.dev/docs/latest/sdk#prompting-and-message-queueing)[Agent and AgentState](https://pi.dev/docs/latest/sdk#agent-and-agentstate)[Events](https://pi.dev/docs/latest/sdk#events)[Options Reference](https://pi.dev/docs/latest/sdk#options-reference)[Directories](https://pi.dev/docs/latest/sdk#directories)[Model](https://pi.dev/docs/latest/sdk#model)[API Keys and OAuth](https://pi.dev/docs/latest/sdk#api-keys-and-oauth)[System Prompt](https://pi.dev/docs/latest/sdk#system-prompt)[Tools](https://pi.dev/docs/latest/sdk#tools)[Custom Tools](https://pi.dev/docs/latest/sdk#custom-tools)[Extensions](https://pi.dev/docs/latest/sdk#extensions)[Skills](https://pi.dev/docs/latest/sdk#skills)[Context Files](https://pi.dev/docs/latest/sdk#context-files)[Slash Commands](https://pi.dev/docs/latest/sdk#slash-commands)[Session Management](https://pi.dev/docs/latest/sdk#session-management)[Settings Management](https://pi.dev/docs/latest/sdk#settings-management)[ResourceLoader](https://pi.dev/docs/latest/sdk#resourceloader)[Return Value](https://pi.dev/docs/latest/sdk#return-value)[Complete Example](https://pi.dev/docs/latest/sdk#complete-example)[Run Modes](https://pi.dev/docs/latest/sdk#run-modes)[InteractiveMode](https://pi.dev/docs/latest/sdk#interactivemode)[runPrintMode](https://pi.dev/docs/latest/sdk#runprintmode)[runRpcMode](https://pi.dev/docs/latest/sdk#runrpcmode)[RPC Mode Alternative](https://pi.dev/docs/latest/sdk#rpc-mode-alternative)[Exports](https://pi.dev/docs/latest/sdk#exports)
Docs
## Start here
...
`Ctrl K`
  ...
  2. [](https://pi.dev/docs/latest/sdk)
  3. [](https://pi.dev/docs/latest/sdk)
  4. [](https://pi.dev/docs/latest/sdk)
  5. [](https://pi.dev/docs/latest/sdk)
  6. [](https://pi.dev/docs/latest/sdk)
  7. [](https://pi.dev/docs/latest/sdk)
  8. [](https://pi.dev/docs/latest/sdk)
  9. [](https://pi.dev/docs/latest/sdk)
  10. [](https://pi.dev/docs/latest/sdk)
...
[Quick Start](https://pi.dev/docs/latest/sdk#quick-start)[Installation](https://pi.dev/docs/latest/sdk#installation)[Core Concepts](https://pi.dev/docs/latest/sdk#core-concepts)[createAgentSession()](https://pi.dev/docs/latest/sdk#createagentsession)[AgentSession](https://pi.dev/docs/latest/sdk#agentsession)[createAgentSessionRuntime() and AgentSessionRuntime](https://pi.dev/docs/latest/sdk#createagentsessionruntime-and-agentsessionruntime)[Prompting and Message Queueing](https://pi.dev/docs/latest/sdk#prompting-and-message-queueing)[Agent and AgentState](https://pi.dev/docs/latest/sdk#agent-and-agentstate)[Events](https://pi.dev/docs/latest/sdk#events)[Options Reference](https://pi.dev/docs/latest/sdk#options-reference)[Directories](https://pi.dev/docs/latest/sdk#directories)[Model](https://pi.dev/docs/latest/sdk#model)[API Keys and OAuth](https://pi.dev/docs/latest/sdk#api-keys-and-oauth)[System Prompt](https://pi.dev/docs/latest/sdk#system-prompt)[Tools](https://pi.dev/docs/latest/sdk#tools)[Custom Tools](https://pi.dev/docs/latest/sdk#custom-tools)[Extensions](https://pi.dev/docs/latest/sdk#extensions)[Skills](https://pi.dev/docs/latest/sdk#skills)[Context Files](https://pi.dev/docs/latest/sdk#context-files)[Slash Commands](https://pi.dev/docs/latest/sdk#slash-commands)[Session Management](https://pi.dev/docs/latest/sdk#session-management)[Settings Management](https://pi.dev/docs/latest/sdk#settings-management)[ResourceLoader](https://pi.dev/docs/latest/sdk#resourceloader)[Return Value](https://pi.dev/docs/latest/sdk#return-value)[Complete Example](https://pi.dev/docs/latest/sdk#complete-example)[Run Modes](https://pi.dev/docs/latest/sdk#run-modes)[InteractiveMode](https://pi.dev/docs/latest/sdk#interactivemode)[runPrintMode](https://pi.dev/docs/latest/sdk#runprintmode)[runRpcMode](https://pi.dev/docs/latest/sdk#runrpcmode)[RPC Mode Alternative](https://pi.dev/docs/latest/sdk#rpc-mode-alternative)[Exports](https://pi.dev/docs/latest/sdk#exports)
# SDK
Latest·[](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/sdk.md)·[](https://github.com/earendil-works/pi/edit/main/packages/coding-agent/docs/sdk.md)
...
##  Installation 
[ Copied ](https://pi.dev/docs/latest/sdk#installation)
...
##  Core Concepts 
[ Copied ](https://pi.dev/docs/latest/sdk#core-concepts)
###  createAgentSession() 
[ Copied ](https://pi.dev/docs/latest/sdk#createagentsession)
...
###  AgentSession 
[ Copied ](https://pi.dev/docs/latest/sdk#agentsession)
...
[ Copied ](https://pi.dev/docs/latest/sdk#createagentsessionruntime-and-agentsessionruntime)
...
[ Copied ](https://pi.dev/docs/latest/sdk#prompting-and-message-queueing)
...
[ Copied ](https://pi.dev/docs/latest/sdk#agent-and-agentstate)
...
###  Events 
[ Copied ](https://pi.dev/docs/latest/sdk#events)
...
##  Options Reference 
[ Copied ](https://pi.dev/docs/latest/sdk#options-reference)
###  Directories 
[ Copied ](https://pi.dev/docs/latest/sdk#directories)
...
###  Model 
[ Copied ](https://pi.dev/docs/latest/sdk#model)
...
###  API Keys and OAuth 
[ Copied ](https://pi.dev/docs/latest/sdk#api-keys-and-oauth)
...
###  System Prompt 
[ Copied ](https://pi.dev/docs/latest/sdk#system-prompt)
...
###  Tools 
[ Copied ](https://pi.dev/docs/latest/sdk#tools)
...
[ Copied ](https://pi.dev/docs/latest/sdk#tools-with-custom-cwd)
...
> See [examples/sdk/05-tools.ts](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/examples/sdk/05-tools.ts)
###  Extensions 
[ Copied ](https://pi.dev/docs/latest/sdk#extensions)
...
###  Skills 
[ Copied ](https://pi.dev/docs/latest/sdk#skills)
...
###  Context Files 
[ Copied ](https://pi.dev/docs/latest/sdk#context-files)
...
###  Slash Commands 
[ Copied ](https://pi.dev/docs/latest/sdk#slash-commands)
...
###  Session Management 
[ Copied ](https://pi.dev/docs/latest/sdk#session-management)
...
##  ResourceLoader 
[ Copied ](https://pi.dev/docs/latest/sdk#resourceloader)
...
##  Return Value 
[ Copied ](https://pi.dev/docs/latest/sdk#return-value)
...
##  Run Modes 
[ Copied ](https://pi.dev/docs/latest/sdk#run-modes)
The SDK exports run mode utilities for building custom interfaces on top of `createAgentSession()`:
###  InteractiveMode 
[ Copied ](https://pi.dev/docs/latest/sdk#interactivemode)
...
###  runPrintMode 
[ Copied ](https://pi.dev/docs/latest/sdk#runprintmode)
...
###  runRpcMode 
[ Copied ](https://pi.dev/docs/latest/sdk#runrpcmode)
...
[ Copied ](https://pi.dev/docs/latest/sdk#rpc-mode-alternative)
...
##  Exports 
[ Copied ](https://pi.dev/docs/latest/sdk#exports)
