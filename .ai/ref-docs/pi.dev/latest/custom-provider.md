...
Navigation
On this page
[Example Extensions](https://pi.dev/docs/latest/custom-provider#example-extensions)[Table of Contents](https://pi.dev/docs/latest/custom-provider#table-of-contents)[Quick Reference](https://pi.dev/docs/latest/custom-provider#quick-reference)[Override Existing Provider](https://pi.dev/docs/latest/custom-provider#override-existing-provider)[Register New Provider](https://pi.dev/docs/latest/custom-provider#register-new-provider)[Unregister Provider](https://pi.dev/docs/latest/custom-provider#unregister-provider)[API Types](https://pi.dev/docs/latest/custom-provider#api-types)[Auth Header](https://pi.dev/docs/latest/custom-provider#auth-header)[OAuth Support](https://pi.dev/docs/latest/custom-provider#oauth-support)[OAuthLoginCallbacks](https://pi.dev/docs/latest/custom-provider#oauthlogincallbacks)[OAuthCredentials](https://pi.dev/docs/latest/custom-provider#oauthcredentials)[Custom Streaming API](https://pi.dev/docs/latest/custom-provider#custom-streaming-api)[Stream Pattern](https://pi.dev/docs/latest/custom-provider#stream-pattern)[Event Types](https://pi.dev/docs/latest/custom-provider#event-types)[Content Blocks](https://pi.dev/docs/latest/custom-provider#content-blocks)[Tool Calls](https://pi.dev/docs/latest/custom-provider#tool-calls)[Usage and Cost](https://pi.dev/docs/latest/custom-provider#usage-and-cost)[Context Overflow Errors](https://pi.dev/docs/latest/custom-provider#context-overflow-errors)[Registration](https://pi.dev/docs/latest/custom-provider#registration)[Testing Your Implementation](https://pi.dev/docs/latest/custom-provider#testing-your-implementation)[Config Reference](https://pi.dev/docs/latest/custom-provider#config-reference)[Model Definition Reference](https://pi.dev/docs/latest/custom-provider#model-definition-reference)
Docs
## Start here
...
`Ctrl K`
  1. [](https://pi.dev/docs/latest/custom-provider)
  2. [](https://pi.dev/docs/latest/custom-provider)
  3. [](https://pi.dev/docs/latest/custom-provider)
  4. [](https://pi.dev/docs/latest/custom-provider)
  5. [](https://pi.dev/docs/latest/custom-provider)
  6. [](https://pi.dev/docs/latest/custom-provider)
  7. [](https://pi.dev/docs/latest/custom-provider)
  8. [](https://pi.dev/docs/latest/custom-provider)
  9. [](https://pi.dev/docs/latest/custom-provider)
  10. [](https://pi.dev/docs/latest/custom-provider)
...
[Example Extensions](https://pi.dev/docs/latest/custom-provider#example-extensions)[Table of Contents](https://pi.dev/docs/latest/custom-provider#table-of-contents)[Quick Reference](https://pi.dev/docs/latest/custom-provider#quick-reference)[Override Existing Provider](https://pi.dev/docs/latest/custom-provider#override-existing-provider)[Register New Provider](https://pi.dev/docs/latest/custom-provider#register-new-provider)[Unregister Provider](https://pi.dev/docs/latest/custom-provider#unregister-provider)[API Types](https://pi.dev/docs/latest/custom-provider#api-types)[Auth Header](https://pi.dev/docs/latest/custom-provider#auth-header)[OAuth Support](https://pi.dev/docs/latest/custom-provider#oauth-support)[OAuthLoginCallbacks](https://pi.dev/docs/latest/custom-provider#oauthlogincallbacks)[OAuthCredentials](https://pi.dev/docs/latest/custom-provider#oauthcredentials)[Custom Streaming API](https://pi.dev/docs/latest/custom-provider#custom-streaming-api)[Stream Pattern](https://pi.dev/docs/latest/custom-provider#stream-pattern)[Event Types](https://pi.dev/docs/latest/custom-provider#event-types)[Content Blocks](https://pi.dev/docs/latest/custom-provider#content-blocks)[Tool Calls](https://pi.dev/docs/latest/custom-provider#tool-calls)[Usage and Cost](https://pi.dev/docs/latest/custom-provider#usage-and-cost)[Context Overflow Errors](https://pi.dev/docs/latest/custom-provider#context-overflow-errors)[Registration](https://pi.dev/docs/latest/custom-provider#registration)[Testing Your Implementation](https://pi.dev/docs/latest/custom-provider#testing-your-implementation)[Config Reference](https://pi.dev/docs/latest/custom-provider#config-reference)[Model Definition Reference](https://pi.dev/docs/latest/custom-provider#model-definition-reference)
# Custom Providers
Latest·[](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/custom-provider.md)·[](https://github.com/earendil-works/pi/edit/main/packages/coding-agent/docs/custom-provider.md)
...
##  Example Extensions 
[ Copied ](https://pi.dev/docs/latest/custom-provider#example-extensions)
...
##  Table of Contents 
[ Copied ](https://pi.dev/docs/latest/custom-provider#table-of-contents)
...
##  Quick Reference 
[ Copied ](https://pi.dev/docs/latest/custom-provider#quick-reference)
...
[ Copied ](https://pi.dev/docs/latest/custom-provider#override-existing-provider)
...
[ Copied ](https://pi.dev/docs/latest/custom-provider#register-new-provider)
...
##  Unregister Provider 
[ Copied ](https://pi.dev/docs/latest/custom-provider#unregister-provider)
...
###  API Types 
[ Copied ](https://pi.dev/docs/latest/custom-provider#api-types)
...
###  Auth Header 
[ Copied ](https://pi.dev/docs/latest/custom-provider#auth-header)
...
##  OAuth Support 
[ Copied ](https://pi.dev/docs/latest/custom-provider#oauth-support)
...
###  OAuthLoginCallbacks 
[ Copied ](https://pi.dev/docs/latest/custom-provider#oauthlogincallbacks)
...
###  OAuthCredentials 
[ Copied ](https://pi.dev/docs/latest/custom-provider#oauthcredentials)
...
[ Copied ](https://pi.dev/docs/latest/custom-provider#custom-streaming-api)
...
###  Stream Pattern 
[ Copied ](https://pi.dev/docs/latest/custom-provider#stream-pattern)
...
###  Event Types 
[ Copied ](https://pi.dev/docs/latest/custom-provider#event-types)
...
###  Content Blocks 
[ Copied ](https://pi.dev/docs/latest/custom-provider#content-blocks)
...
###  Tool Calls 
[ Copied ](https://pi.dev/docs/latest/custom-provider#tool-calls)
...
###  Usage and Cost 
[ Copied ](https://pi.dev/docs/latest/custom-provider#usage-and-cost)
...
[ Copied ](https://pi.dev/docs/latest/custom-provider#context-overflow-errors)
...
###  Registration 
[ Copied ](https://pi.dev/docs/latest/custom-provider#registration)
...
[ Copied ](https://pi.dev/docs/latest/custom-provider#testing-your-implementation)
...
##  Config Reference 
[ Copied ](https://pi.dev/docs/latest/custom-provider#config-reference)
...
[ Copied ](https://pi.dev/docs/latest/custom-provider#model-definition-reference)
