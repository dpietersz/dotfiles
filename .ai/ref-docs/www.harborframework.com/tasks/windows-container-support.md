...
source: "https://www.harborframework.com/docs/tasks/windows-container-support"
scraped_at: "2026-06-08T07:02:40Z"
etag: "\"bccc7ffba1f42bf0102a1b9133ba488a\""
---
...
## [Prerequisites](https://www.harborframework.com/docs/tasks/windows-container-support#prerequisites)
...
## [How It Works](https://www.harborframework.com/docs/tasks/windows-container-support#how-it-works)
### [Declaring the target OS](https://www.harborframework.com/docs/tasks/windows-container-support#declaring-the-target-os)
...
### [Daemon-mode and image-OS validation](https://www.harborframework.com/docs/tasks/windows-container-support#daemon-mode-and-image-os-validation)
...
### [Container-Side Paths](https://www.harborframework.com/docs/tasks/windows-container-support#container-side-paths)
...
### [Volume Mounts](https://www.harborframework.com/docs/tasks/windows-container-support#volume-mounts)
...
### [File Transfer (tar-over-exec)](https://www.harborframework.com/docs/tasks/windows-container-support#file-transfer-tar-over-exec)
...
### [Command Execution](https://www.harborframework.com/docs/tasks/windows-container-support#command-execution)
...
### [Container Keepalive](https://www.harborframework.com/docs/tasks/windows-container-support#container-keepalive)
...
### [Environment Variables](https://www.harborframework.com/docs/tasks/windows-container-support#environment-variables)
...
## [Writing Windows Tasks](https://www.harborframework.com/docs/tasks/windows-container-support#writing-windows-tasks)
...
### [Dockerfile](https://www.harborframework.com/docs/tasks/windows-container-support#dockerfile)
...
### [Test Scripts](https://www.harborframework.com/docs/tasks/windows-container-support#test-scripts)
...
### [Multi-Step Tasks](https://www.harborframework.com/docs/tasks/windows-container-support#multi-step-tasks)
...
### [task.toml](https://www.harborframework.com/docs/tasks/windows-container-support#tasktoml)
...
## [Sample Tasks](https://www.harborframework.com/docs/tasks/windows-container-support#sample-tasks)
...
## [Limitations](https://www.harborframework.com/docs/tasks/windows-container-support#limitations)
...
[Managing Resources Declare CPU, memory, storage, GPU, and TPU requirements in tasks and control how Harbor applies them per environment provider.](https://www.harborframework.com/docs/tasks/managing-resources)[Tutorial In this tutorial, we will walk through creating a simple Harbor task.](https://www.harborframework.com/docs/tasks/task-tutorial)
[Prerequisites](https://www.harborframework.com/docs/tasks/windows-container-support#prerequisites)[How It Works](https://www.harborframework.com/docs/tasks/windows-container-support#how-it-works)[Declaring the target OS](https://www.harborframework.com/docs/tasks/windows-container-support#declaring-the-target-os)[Daemon-mode and image-OS validation](https://www.harborframework.com/docs/tasks/windows-container-support#daemon-mode-and-image-os-validation)[Container-Side Paths](https://www.harborframework.com/docs/tasks/windows-container-support#container-side-paths)[Volume Mounts](https://www.harborframework.com/docs/tasks/windows-container-support#volume-mounts)[File Transfer (tar-over-exec)](https://www.harborframework.com/docs/tasks/windows-container-support#file-transfer-tar-over-exec)[Command Execution](https://www.harborframework.com/docs/tasks/windows-container-support#command-execution)[Container Keepalive](https://www.harborframework.com/docs/tasks/windows-container-support#container-keepalive)[Environment Variables](https://www.harborframework.com/docs/tasks/windows-container-support#environment-variables)[Writing Windows Tasks](https://www.harborframework.com/docs/tasks/windows-container-support#writing-windows-tasks)[Dockerfile](https://www.harborframework.com/docs/tasks/windows-container-support#dockerfile)[Test Scripts](https://www.harborframework.com/docs/tasks/windows-container-support#test-scripts)[Multi-Step Tasks](https://www.harborframework.com/docs/tasks/windows-container-support#multi-step-tasks)[task.toml](https://www.harborframework.com/docs/tasks/windows-container-support#tasktoml)[Sample Tasks](https://www.harborframework.com/docs/tasks/windows-container-support#sample-tasks)[Limitations](https://www.harborframework.com/docs/tasks/windows-container-support#limitations)
