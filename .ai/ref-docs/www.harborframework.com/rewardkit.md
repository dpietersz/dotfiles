...
source: "https://www.harborframework.com/docs/rewardkit"
scraped_at: "2026-06-08T07:02:40Z"
etag: "\"516b8b20da7c1356ff748f675c89bdee\""
---
...
## [Installation](https://www.harborframework.com/docs/rewardkit#installation)
...
## [Using with Harbor](https://www.harborframework.com/docs/rewardkit#using-with-harbor)
...
To swap providers without editing the rubric, see [Provider routing](https://www.harborframework.com/docs/rewardkit#provider-routing).
...
There are 20+ built-in criteria covering frequently used criteria for grading files, commands, JSON, CSV, HTTP, images, and agent trajectories. See [Built-in Criteria](https://www.harborframework.com/docs/rewardkit/built-in-criteria) for the full list.
## [Custom criteria](https://www.harborframework.com/docs/rewardkit#custom-criteria)
...
See [Judge Criteria](https://www.harborframework.com/docs/rewardkit/judge-criteria) for the full TOML configuration reference including agent judges and trajectory evaluation.
## [Multi-reward tasks](https://www.harborframework.com/docs/rewardkit#multi-reward-tasks)
...
## [Weights and scoring](https://www.harborframework.com/docs/rewardkit#weights-and-scoring)
...
## [Isolation](https://www.harborframework.com/docs/rewardkit#isolation)
...
## [Output](https://www.harborframework.com/docs/rewardkit#output)
...
## [Comparing verifiers](https://www.harborframework.com/docs/rewardkit#comparing-verifiers)
...
## [CLI](https://www.harborframework.com/docs/rewardkit#cli)
...
## [Provider routing](https://www.harborframework.com/docs/rewardkit#provider-routing)
...
## [Python API](https://www.harborframework.com/docs/rewardkit#python-api)
...
[LLM-as-a-Judge How to use an LLM to score agent outputs instead of deterministic tests.](https://www.harborframework.com/docs/tutorials/llm-as-a-judge)[Judge Criteria Evaluating agent outputs with LLMs or agent CLIs via TOML configuration](https://www.harborframework.com/docs/rewardkit/judge-criteria)
[Installation](https://www.harborframework.com/docs/rewardkit#installation)[Using with Harbor](https://www.harborframework.com/docs/rewardkit#using-with-harbor)[Built-in criteria](https://www.harborframework.com/docs/rewardkit#built-in-criteria)[Custom criteria](https://www.harborframework.com/docs/rewardkit#custom-criteria)[Judge criteria](https://www.harborframework.com/docs/rewardkit#judge-criteria)[Multi-reward tasks](https://www.harborframework.com/docs/rewardkit#multi-reward-tasks)[Weights and scoring](https://www.harborframework.com/docs/rewardkit#weights-and-scoring)[Isolation](https://www.harborframework.com/docs/rewardkit#isolation)[Output](https://www.harborframework.com/docs/rewardkit#output)[Comparing verifiers](https://www.harborframework.com/docs/rewardkit#comparing-verifiers)[CLI](https://www.harborframework.com/docs/rewardkit#cli)[Provider routing](https://www.harborframework.com/docs/rewardkit#provider-routing)[Python API](https://www.harborframework.com/docs/rewardkit#python-api)
