...
source: "https://www.harborframework.com/docs/agents/trajectory-format"
scraped_at: "2026-06-08T07:02:40Z"
etag: "\"76f7d42e44b3dce2901fee2f8eba8a59\""
---
...
Agent Trajectory Format (ATIF)Overview
Agents
# Agent Trajectory Format (ATIF)
Copy Markdown
Understanding and working with the Agent Trajectory Interchange Format
## [Overview](https://www.harborframework.com/docs/agents/trajectory-format#overview)
...
## [Key Features](https://www.harborframework.com/docs/agents/trajectory-format#key-features)
...
## [Harbor Support](https://www.harborframework.com/docs/agents/trajectory-format#harbor-support)
...
### [Supported Agents](https://www.harborframework.com/docs/agents/trajectory-format#supported-agents)
...
### [OpenHands Example](https://www.harborframework.com/docs/agents/trajectory-format#openhands-example)
...
## [Data Classes](https://www.harborframework.com/docs/agents/trajectory-format#data-classes)
Harbor provides Pydantic models for all ATIF schema components in `harbor.models.trajectories`:
### [Core Models](https://www.harborframework.com/docs/agents/trajectory-format#core-models)
...
### [Export to JSON](https://www.harborframework.com/docs/agents/trajectory-format#export-to-json)
...
## [Validation](https://www.harborframework.com/docs/agents/trajectory-format#validation)
Harbor provides a trajectory validator for validating ATIF trajectory files:
### [Command Line](https://www.harborframework.com/docs/agents/trajectory-format#command-line)
...
### [Programmatic Usage](https://www.harborframework.com/docs/agents/trajectory-format#programmatic-usage)
...
## [Building Custom Trajectories](https://www.harborframework.com/docs/agents/trajectory-format#building-custom-trajectories)
...
## [Schema Versions](https://www.harborframework.com/docs/agents/trajectory-format#schema-versions)
...
## [Related Resources](https://www.harborframework.com/docs/agents/trajectory-format#related-resources)
...
[Terminus-2 Harbor's high-performance reference agent implementation](https://www.harborframework.com/docs/agents/terminus-2)[RL Reinforcement learning on Harbor tasks](https://www.harborframework.com/docs/training-workflows/rl)
[Overview](https://www.harborframework.com/docs/agents/trajectory-format#overview)[Key Features](https://www.harborframework.com/docs/agents/trajectory-format#key-features)[Harbor Support](https://www.harborframework.com/docs/agents/trajectory-format#harbor-support)[Supported Agents](https://www.harborframework.com/docs/agents/trajectory-format#supported-agents)[OpenHands Example](https://www.harborframework.com/docs/agents/trajectory-format#openhands-example)[Data Classes](https://www.harborframework.com/docs/agents/trajectory-format#data-classes)[Core Models](https://www.harborframework.com/docs/agents/trajectory-format#core-models)[Export to JSON](https://www.harborframework.com/docs/agents/trajectory-format#export-to-json)[Validation](https://www.harborframework.com/docs/agents/trajectory-format#validation)[Command Line](https://www.harborframework.com/docs/agents/trajectory-format#command-line)[Programmatic Usage](https://www.harborframework.com/docs/agents/trajectory-format#programmatic-usage)[Building Custom Trajectories](https://www.harborframework.com/docs/agents/trajectory-format#building-custom-trajectories)[Schema Versions](https://www.harborframework.com/docs/agents/trajectory-format#schema-versions)[Related Resources](https://www.harborframework.com/docs/agents/trajectory-format#related-resources)
