...
source: "https://www.harborframework.com/docs/agents/terminus-2"
scraped_at: "2026-06-08T07:02:40Z"
etag: "\"ca15adab266fdd0af2070d90a6e5cc4a\""
---
...
## [Overview](https://www.harborframework.com/docs/agents/terminus-2#overview)
...
## [Key Features](https://www.harborframework.com/docs/agents/terminus-2#key-features)
### [Mono-tool Design](https://www.harborframework.com/docs/agents/terminus-2#mono-tool-design)
...
### [Independent Execution](https://www.harborframework.com/docs/agents/terminus-2#independent-execution)
...
### [Autonomy-First Approach](https://www.harborframework.com/docs/agents/terminus-2#autonomy-first-approach)
...
## [Using Terminus-2 with Harbor](https://www.harborframework.com/docs/agents/terminus-2#using-terminus-2-with-harbor)
### [Basic Usage](https://www.harborframework.com/docs/agents/terminus-2#basic-usage)
...
### [Configuration Options](https://www.harborframework.com/docs/agents/terminus-2#configuration-options)
...
## [Conversation History Management](https://www.harborframework.com/docs/agents/terminus-2#conversation-history-management)
...
### [Standard Summarization Process](https://www.harborframework.com/docs/agents/terminus-2#standard-summarization-process)
...
### [Proactive Summarization](https://www.harborframework.com/docs/agents/terminus-2#proactive-summarization)
...
### [Passive Summarization](https://www.harborframework.com/docs/agents/terminus-2#passive-summarization)
...
## [Reinforcement Learning Support](https://www.harborframework.com/docs/agents/terminus-2#reinforcement-learning-support)
Terminus-2 is designed with RL training in mind and collects detailed rollout information for use in RL pipelines.
### [Rollout Details Collection](https://www.harborframework.com/docs/agents/terminus-2#rollout-details-collection)
During execution, Terminus-2 can collect and export:
#### [Token Information](https://www.harborframework.com/docs/agents/terminus-2#token-information)
...
#### [Rewards](https://www.harborframework.com/docs/agents/terminus-2#rewards)
...
## [Trajectory Format](https://www.harborframework.com/docs/agents/terminus-2#trajectory-format)
...
See the [Agent Trajectory Format](https://www.harborframework.com/docs/agents/trajectory-format) documentation for details on the ATIF specification.
### [Trajectory Configuration](https://www.harborframework.com/docs/agents/terminus-2#trajectory-configuration)
...
#### [Configuration Options](https://www.harborframework.com/docs/agents/terminus-2#configuration-options-1)
...
#### [Example Configuration](https://www.harborframework.com/docs/agents/terminus-2#example-configuration)
...
## [Related Documentation](https://www.harborframework.com/docs/agents/terminus-2#related-documentation)
  * [Agents Overview](https://www.harborframework.com/docs/agents) - General agent integration guide
  * [Agent Trajectory Format](https://www.harborframework.com/docs/agents/trajectory-format) - ATIF specification and usage
  * [RL Training](https://www.harborframework.com/docs/training-workflows/rl) - Using Terminus-2 for reinforcement learning
  * [SFT Datasets](https://www.harborframework.com/docs/training-workflows/sft) - Generating supervised fine-tuning data


[Agents Using popular agents and integrating your own](https://www.harborframework.com/docs/agents)[Agent Trajectory Format (ATIF) Understanding and working with the Agent Trajectory Interchange Format](https://www.harborframework.com/docs/agents/trajectory-format)
[Overview](https://www.harborframework.com/docs/agents/terminus-2#overview)[Key Features](https://www.harborframework.com/docs/agents/terminus-2#key-features)[Mono-tool Design](https://www.harborframework.com/docs/agents/terminus-2#mono-tool-design)[Independent Execution](https://www.harborframework.com/docs/agents/terminus-2#independent-execution)[Autonomy-First Approach](https://www.harborframework.com/docs/agents/terminus-2#autonomy-first-approach)[Using Terminus-2 with Harbor](https://www.harborframework.com/docs/agents/terminus-2#using-terminus-2-with-harbor)[Basic Usage](https://www.harborframework.com/docs/agents/terminus-2#basic-usage)[Configuration Options](https://www.harborframework.com/docs/agents/terminus-2#configuration-options)[Conversation History Management](https://www.harborframework.com/docs/agents/terminus-2#conversation-history-management)[Standard Summarization Process](https://www.harborframework.com/docs/agents/terminus-2#standard-summarization-process)[Proactive Summarization](https://www.harborframework.com/docs/agents/terminus-2#proactive-summarization)[Passive Summarization](https://www.harborframework.com/docs/agents/terminus-2#passive-summarization)[Reinforcement Learning Support](https://www.harborframework.com/docs/agents/terminus-2#reinforcement-learning-support)[Rollout Details Collection](https://www.harborframework.com/docs/agents/terminus-2#rollout-details-collection)[Token Information](https://www.harborframework.com/docs/agents/terminus-2#token-information)[Rewards](https://www.harborframework.com/docs/agents/terminus-2#rewards)[Trajectory Format](https://www.harborframework.com/docs/agents/terminus-2#trajectory-format)[Trajectory Configuration](https://www.harborframework.com/docs/agents/terminus-2#trajectory-configuration)[Configuration Options](https://www.harborframework.com/docs/agents/terminus-2#configuration-options-1)[Example Configuration](https://www.harborframework.com/docs/agents/terminus-2#example-configuration)[Related Documentation](https://www.harborframework.com/docs/agents/terminus-2#related-documentation)
