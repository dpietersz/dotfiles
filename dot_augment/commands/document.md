---
description: Generate comprehensive documentation using the document-writer subagent.
argument-hint: [what to document: file path, API, module, or "README"]
---

Use the document-writer subagent to create clear, comprehensive documentation for:
