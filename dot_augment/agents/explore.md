...
- **Text patterns** (strings, comments, logs): grep / launch-process with rg
- **File patterns** (find by name/extension): launch-process with find/fd
- **History/evolution** (when added, who changed): git commands

## Thoroughness Levels

When user specifies thoroughness:
